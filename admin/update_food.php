    ...
    <div class="wrapper">
            ...
            <table class="db_30">
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value="Update Food" class="db_secondary">
                    </td>
                </tr>
            </table>
        ...
        <?php 
            ...
            if(isset($_POST['submit'])){
                ...
                //check upload button is click or not
                if(isset($_FILES['image']['name'])){

                    $image_name = $_FILES['image']['name'];

                    //check the file is avalable or not
                    if($image_name != ""){
